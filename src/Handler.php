...
use Log0\Exceptioner\Data;
use Log0\Exceptioner\Sender;
...
class Handler {
    ...
    public static function init() {
        self::$exceptionHandler = set_exception_handler(array('Log0\Exceptioner\Handler', 'handleException'));
        register_shutdown_function(array('Log0\Exceptioner\Handler', 'handleShutdown'));
    }
